                ...
                <Nav className="navbar navbar-light navbar-expand-md sticky-top bg-white" style={{
                    ...
                    <div className="container-fluid"><a className="navbar-brand" href="#" style={{
                        ...
                        <div className="collapse navbar-collapse d-flex justify-content-end" id="navcol-1">
                            ...
                            <button className=" button1 btn btn-outline-primary" type="button" onClick={props.loginOnClick} style={{
                                background: "rgba(255,255,255,0)"
                                }} >Log In</button>
                            
                            <button className=" button2 btn btn-primary d-flex" type="button" onClick={props.signUpOnClick}>Sign Up</button>
                        </div>
                    </div>
                </Nav>
            </div>
